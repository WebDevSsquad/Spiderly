...
const RecentSearch = ({ recentSearchList, setRecentSearchList }) => {
...
const addSearchItem = (searchValue, recentSearchList, setRecentSearchList) => {
...
const Search = ({ handleSearch, className }) => {
  ...
  const handleSearchSystem = (value) => {
    ...
    addSearchItem(value, recentSearchList, setRecentSearchList);
  };
  return (
    <div className={`${SearchCSS.search_body} ${className}`}>
      <Searchbar
        handleSearch={handleSearchSystem}
      />
